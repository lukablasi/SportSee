  ...
  return (
    <div className="key-data-container">
      <div className="key-data">
        ...
        <div className="key-data-details">
          <div>
          ...
          <div className="key-data-name">Calories</div>
        </div>
      </div>
      <div className="key-data">
        <svg
        ...
        <div className="key-data-details">
          <div>{keyData.proteinCount}g</div>
          <div className="key-data-name">Proteins</div>
        </div>
      </div>
      <div className="key-data">
        <svg
        ...
        <div className="key-data-details">
          <div>{keyData.carbohydrateCount}g</div>
          <div className="key-data-name">Carbs</div>
        </div>
      </div>
      <div className="key-data">
        <svg
        ...
        <div className="key-data-details">
          <div>{keyData.lipidCount}g</div>
          <div className="key-data-name">Lipides</div>
        </div>
      </div>
    </div>
  );
